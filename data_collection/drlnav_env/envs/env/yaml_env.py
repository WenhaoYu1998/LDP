...
class ImageEnv(gym.Env):
    ...
    def save_envs_bag(self, ep_total, bag_name):
        pkg_path = get_pkg_path('img_env')
        output_dir = osp.abspath(osp.join(pkg_path, 'cfg_bag/failure_bag/'))
    ...
    def _get_states(self, robot_states):
        ...
        for i in range(len(self.reset_req.obstacles)):
            obs_msg_dict = {}
            obs_msg_dict['position'] = [self.reset_req.obstacles[i].init_pose.position.x, 
                                        self.reset_req.obstacles[i].init_pose.position.y, 
                                        self.reset_req.obstacles[i].init_pose.position.z]
            obs_msg_dict['orientation'] = [self.reset_req.obstacles[i].init_pose.orientation.x,
            ...
            obs_msg_dict['shape'] = self.reset_req.obstacles[i].shape
            obs_msg_dict['size'] = self.reset_req.obstacles[i].size
        ...
        for i in range(len(self.reset_req.robots)):
            robot_msg_dict = {}
            robot_msg_dict['init_position'] = [self.reset_req.robots[i].init_pose.position.x, 
                                               self.reset_req.robots[i].init_pose.position.y, 
                                               self.reset_req.robots[i].init_pose.position.z]
            robot_msg_dict['orientation'] = [self.reset_req.robots[i].init_pose.orientation.x,
            ...
            robot_msg_dict['goal'] = [self.reset_req.robots[i].goal.x,
