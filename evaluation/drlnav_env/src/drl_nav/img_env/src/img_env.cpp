        ...
        if (i == robot_total_ - 1)
        {
            ...
            for (int j = 0; j < robot_total_; j++)
            {
                ...
                if (robots_[j].shape_ == "rectangle"){
                    if(is_draw_traj)
                        // robots_[j].draw_line(EnvMap_maps_.visual_map_, colors_[4], "world_map", robots_[j].visual_traj_);
                        // cout << robots_[j].visual_traj_ << endl;
                        robots_[j].draw_line(EnvMap_maps_.visual_map_, colors_[4], "world_map", robots_[j].visual_global_path_);
                }
                vector<Point2d> head;
