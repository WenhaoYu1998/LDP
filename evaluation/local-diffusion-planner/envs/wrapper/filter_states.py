...
class ObsStateTmp(gym.ObservationWrapper):
    ...
    def observation(self, states: ImageState):
        ...
        return [states.sensor_maps, states.vector_states, states.target_pose, states.pose, states.global_maps, states.target_pose_visual, states.pose_visual, states.obs_list]
