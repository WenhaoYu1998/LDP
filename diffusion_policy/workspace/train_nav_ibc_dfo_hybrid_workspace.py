...
class TrainIbcDfoHybridWorkspace(BaseWorkspace):
    ...
    def run(self):
        ...
        if cfg.training.resume:
            ...
            lastest_ckpt_path = pathlib.Path('/home/amax/ywh/diffusion_policy/data/outputs/2024.02.28/13.35.58_train_ibc_dfo_hybrid_nav_image/checkpoints/epoch_200.ckpt')
